...
function runAiClassification() {
  ...
  const theftWords    = ['steal','stole','stolen','theft','rob','robbed','robbery','snatch','snatched','burglar','pickpocket','hold-up','holdup','missing item','nawala','ninakaw','nanakaw'];
  const domesticWords = ['domestic','fight','fighting','quarrel','abuse','violence','battered','beaten','couples','asawa','suntok','sampal','away'];
  const propertyWords = ['fence','boundary','lot','property','encroach','trespass','titulo','tct','easement','land','lupa'];
  const envWords      = ['garbage','trash','basura','flood','flooding','canal','waste','littering','illegal dump','smoke','fumes','ilog'];
  const noiseWords    = ['noise','loud','music','videoke','karaoke','ingay','maingay','tunog','barking','dog','konstruksiyon','construction'];
